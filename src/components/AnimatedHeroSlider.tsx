...
const slides = [
  {
    ...
    gradient: "from-violet-500/70 via-purple-500/70 to-blue-400/70",
  },
  {
    id: 2,
    ...
    gradient: "from-blue-500/70 via-indigo-500/70 to-purple-400/70",
  },
  {
    id: 3,
    ...
    gradient: "from-indigo-500/70 via-purple-500/70 to-blue-500/70",
  },
];
...
const AnimatedHeroSlider = () => {
  ...
  return (
    <section className="relative h-[85vh] overflow-hidden">
      ...
      <div className="absolute top-40 -right-20 w-72 h-72 bg-blue-400/30 rounded-full blur-3xl animate-pulse animation-delay-2000"></div>
      <div className="absolute -bottom-20 left-1/3 w-80 h-80 bg-indigo-400/20 rounded-full blur-3xl animate-pulse animation-delay-4000"></div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl text-white">
              ...
              <div className="flex flex-wrap gap-4 animate-slide-up animation-delay-600">
                ...
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/20 hover:border-white/80">
