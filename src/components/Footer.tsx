        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/artist-signup" className="text-sm text-white/70 hover:text-white transition-colors">
                  Join as Artist
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/artist-resources" className="text-sm text-white/70 hover:text-white transition-colors">
                  Resources
                </Link>
              </li>
              <li>
                <Link to="/success-stories" className="text-sm text-white/70 hover:text-white transition-colors">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/client-testimonials" className="text-sm text-white/70 hover:text-white transition-colors">
                  Testimonials
                </Link>
              </li>
            </ul>
